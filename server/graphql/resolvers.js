...
//     // Match creator name
//     if (query.creator) {
//       mongoQuery.creator_name = {
//         $regex: new RegExp(`^${query.creator}$`, 'i'),
//       }
//     }
...
//     if (!query)
//       return []
//     if (!query.name && (!query.gameID || query.gameID.length <= 0))
//       return []
...
//       mongoQuery.id = await Clip.find({
//         broadcaster_id: query.broadcasterID,
//       }).distinct('game_id')
//     }
...
//     return await Game.find(mongoQuery)
//   },
// }
